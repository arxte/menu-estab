...
function plusDish(id: number, price: number) {
  console.log(id)
  dishesStore.countDishesInBasket++
  dishesStore.plusCountAmount(id)
...
function minusDish(id: number, price: number) {
  console.log(id)
  dishesStore.countDishesInBasket--
  dishesStore.minusCountAmount(id)
      ...
      <article class="basket-dish" v-for="dish in dishesStore.inBasketDishFirst" :key="dish.id">
        ...
        <div class="basket-dish__info info-dish">
          ...
          <div class="info-dish-button">
            <div class="info-dish-button-plus" @click="plusDish(dish.id, dish.price)">
            ...
            <div class="info-dish-button-minus" @click="minusDish(dish.id, dish.price)">
